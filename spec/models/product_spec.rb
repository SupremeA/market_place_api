...
describe Product do
  ...
  describe ".filter_by_title" do
    before(:each) do
      ...
      @product2 = FactoryGirl.create :product, title: "MacBook Laptop"
      @product3 = FactoryGirl.create :product, title: "Ipod"
      @product4 = FactoryGirl.create :product, title: "DLP 65inch TV"
